...
public class MergeTwoSortedLists {
	/*
	 * Solution : Iterative, loop while one of the list is empty and compare the
	 * elements and move curr node pointers based on condition Runtime : O(N),
	 * Space : O(1) https://www.interviewbit.com/problems/merge-two-sorted-lists/
	 */
	...
	/*
	 * Solution : Recursive approach. Runtime : O(N), Space : O(N) - due to call
	 * stack.
	 */
	private static Node mergeRecursive(Node list1, Node list2) {
	...
	public static void main(String[] args) {
		...
		head4.next.next = new Node(9);
		
		Node mergedList = mergeRecursive(head3, head4);
