...
public class ProductExceptSelf {
	...
	/*
	 * Brute force solution, loop (2 loops) through the array and calculate product except self Runtime
	 * : O(N^2) Space : O(N) - output array
	 */
	public static int[] findProductExceptSelfV1(int[] arr) {
	...
	/*
	 * When we multiply all values of array before and after each index, we get our answer — the product
	 * of all the integers except arr[i]. Runtime : O(N) - multiple passes Space : O(N) - only for
	 * output array
	 */
	...
	/*
	 * When we multiply all values of array before and after each index, we get our answer — the product
	 * of all the integers except arr[i]. Runtime : O(N) - single pass Space : O(N) - only for output
	 * array
	 */
